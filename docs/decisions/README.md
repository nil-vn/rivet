...
Thư mục này lưu các quyết định kiến trúc bất biến theo thời gian. Quy trình và template được mô tả trong [`docs/development/adr-process.md`](../development/adr-process.md).
...
| [0004](0004-byte-accounted-resource-permits.md) | Byte-accounted memory và temporary-disk permits | Accepted | 2026-08-05 |
